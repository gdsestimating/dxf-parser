		...
		while(curr !== 'EOF') {
			...
			switch(curr.code) {
				...
				case 42: // bulge
					...
					break;
				case 70: // flags
					entity.curve_fitting_vertex = (curr.value | 1) !== 0;
					entity.curve_fit_tangent = (curr.value | 2) !== 0;
					entity.spline_vertex = (curr.value | 8) !== 0;
					entity.spline_control_point = (curr.value | 16) !== 0;
					entity.threed_polyline_vertex = (curr.value | 32) !== 0;
					entity.threed_polyline_mesh = (curr.value | 64) !== 0;
					entity.polyface_mesh_vertex = (curr.value | 128) !== 0;
					curr = scanner.next();
					break;
		...
		while (curr !== 'EOF') {
			...
			switch(curr.code) {
				...
				case 50:
					...
					break;
				case 51:
					entity.oblique_angle = curr.value;
					curr = scanner.next();
					break;
				case 70:
					entity.invisible = !!(curr.value & 0x01);
					entity.constant = !!(curr.value & 0x02);
					entity.verification_required = !!(curr.value & 0x04);
				...
				case 72:
					// TODO: enum values?
					entity.horizontal_justification = curr.value;
					curr = scanner.next();
					break;
				case 73:
					entity.field_length = curr.value;
					curr = scanner.next();
					break;
				case 74:
					// TODO: enum values?
					entity.vertical_justification = curr.value;
					curr = scanner.next();
					break;
				case 100:
					// subclass
					...
					break;
				case 210:
					entity.extrusion_direction_x = curr.value;
					curr = scanner.next();
					break;
				case 220:
					entity.extrusion_direction_y = curr.value;
					curr = scanner.next();
					break;
				case 230:
					entity.extrusion_direction_z = curr.value;
					curr = scanner.next();
					break;
				default:
					checkCommonEntityProperties(entity);
